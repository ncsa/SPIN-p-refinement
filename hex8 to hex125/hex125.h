 ...
 */
typedef struct edge {
	int node_id[3];   /**< Node IDs unique to each edge */
	double x[3];	  /**< X coordinates of nodes in edge */
	double y[3];	  /**< Y coordinates of nodes in edge */
	double z[3];	  /**< Z coordinates of nodes in edge */
 ...
 */
typedef struct face {
	int node_id[9];	  /**< Node IDs unique to each face */
	double x[9];	  /**< X coordinates of nodes in face */
	double y[9];	  /**< Y coordinates of nodes in face */
	double z[9];	  /**< Z coordinates of nodes in face */
...
typedef struct internal {
	int node_id[27];  /**< Node IDs unique to each internal */

	double x[27];	  /**< X coordinates of nodes in internal */
	double y[27];	  /**< Y coordinates of nodes in internal */
	double z[27];	  /**< Z coordinates of nodes in internal */
...
*/
void toHex125( const char* msh_file );
/**
...
*/
char* getEdgeNodeId( int elem_id, int num_nodes, edge_t** edges, int num_elements, char* all_coords[num_elements*117], char ** nodes, int n1, int n2 );
/**
...
*/
char* getFaceNodeId( int elem_id, int num_nodes, face_t** faces, int num_elements, char* all_coords[num_elements*117], char ** nodes, int n1, int n2, int n3, int n4 );
/**
...
*/
char* getInternalNodeId( int elem_id, int num_elements, internal_t** internals, char* all_coords[num_elements*117], char** nodes, int n1, int n2, int n3, int n4, int n5, int n6, int n7, int n8 );
// Math functions
/**
